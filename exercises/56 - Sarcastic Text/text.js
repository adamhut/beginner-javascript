...
const filters = {
    sarcastic:function(letter,index){
        ...
        // if it is odd , it will reutnr 1, and that is truthy  , so this if statement will trip
        if(index%2==0){
    ...
    funky:function(letter){
        //check if there is a funky letter form this case
        let funkyLetter = funkyLetters[letter];
        if (funkyLetter)
        {
            return funkyLetter;
        }
        // if there is not , check if tere is a lowercase version
        funkyLetter = funkyLetters[letter.toLowerCase()]
        if (funkyLetter) {
            return funkyLetter;
        }
        //if there nothing, return the regular 
        return letter;
    },
